...
def canny(img, low_threshold, high_threshold): # Canny 알고리즘 가장자리 검출 알고리즘 (Edge detection)
...
image = cv2.imread('/home/capstone/Desktop/Driving/Input_data_mp4/Demo/DemoImage.PNG') # 이미지 읽기
...
"""
ROI_result = weighted_img(ROI_img, image)
cv2.imshow('ROI_result',ROI_result)
"""
