...
# 이미지와 color로 채워진 ROI를 합침
	...
	return ROI_image
def draw_lines(img, lines, color=[255, 255, 0], thickness=5): # 선 그리기
	for line in lines:
...
while(cap.isOpened()):
	...
	result2 = weighted_img(hough_img, image)
#	print (ROI_IMG	
#	print (hough_img)
#	print (image)
#	print(result/2)
#	resutl2 = result/2;
	...
	line_arr = np.squeeze(line_arr)
	draw_lines(temp, R_lines)"""
#	cv2.imshow('/home/capstone/Desktop/Driving/Input_data_mp4/result',result) # 결과 이미지 출력
	cv2.imshow('/home/capstone/Desktop/Driving/Input_data_mp4/result',result2) # 결과 이미지 출력
