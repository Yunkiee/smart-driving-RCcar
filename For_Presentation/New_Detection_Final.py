...
def detect_lanes_img(img): #1
	...
	while 1:
		if View_center < int(center_circle1) and int(center_circle1) - View_center > 30: #차선인식의 범위가 많은 경우 그 차이만큼 움직이는 것이 아닌 최소한의 차이만 이
...
#cap = cv2.VideoCapture('/home/capstone/Desktop/Driving/Input_data_mp4/uturn2.MOV')
