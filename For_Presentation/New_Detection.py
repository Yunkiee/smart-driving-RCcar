...
def detect_lanes_img(img): #1
	...
	while 1:
		if View_center < int(center_circle1) and int(center_circle1) - View_center > 35 and int(center_circle1) - View_center < 300: 
			View_center=center_circle1
			#View_center+=10
			print("Right", View_center ," -> ", center_circle1)
		elif View_center > int(center_circle1) and View_center - int(center_circle1) > 35hnj and View_center - int(center_circle1) < 300:
			View_center=center_circle1
			#View_center-=10
